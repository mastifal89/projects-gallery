 ...
 */`,
  ...
  },
  {
    ...
    content: `/*
 Education
 - B.Sc. in Computer Science from University X (2015-2019)
 - M.Sc. in Software Engineering from University Y (2019-2021)
 - Various online courses and certifications in web development and AI
 */`,
          ...
          <div className={styles.contactSources}>
            <div className={styles.contactSourcesItem}>
              <Image
                ...
                width={15}
                alt="image"
                className={styles.sourceItemsImage}
                src="/icons/email.svg"
              />
          ...
          <div className={styles.bodyTab}>
            <div className={styles.tab}>
              ...
              <Image
                ...
                width={15}
                alt="image"
                className={styles.personalInfoImg}
                src="/icons/close.svg"
              />
            </div>
          </div>
            ...
            <pre className={styles.bodyText}>
              <code className="language-javascript">
                <span className={styles.textContent}>
                  {formatContent(personalInfo[section].content)}
                </span>
              </code>
            </pre>
